...
Source: https://tencentarena.com/docs/p-competition-gorge_chase/15.0.1/guidebook/dev-guide/agent/
...
代码包仅提供了最基础的智能体实现，用户可以仔细阅读[环境详述](/docs/p-competition-gorge_chase/15.0.1/guidebook/dev-guide/env/)和[数据协议](/docs/p-competition-gorge_chase/15.0.1/guidebook/dev-guide/protocol/)，根据自己对环境的理解，进行特征工程、奖励开发等工作，不断提升智能体的能力。
